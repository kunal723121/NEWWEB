    ...
    <div className="container">
        <div className="row">
            ...
            <form ref={form} onSubmit={sendEmail}>
                            <label>Name</label>
                            <input className="form-control" placeholder="enter your name..." type="text" name="user_name" />
                            <label>Email</label>
                            <input className="form-control" type="email" placeholder="enter your email..." name="user_email" />
                            <label>Message</label>
                            <textarea className="form-control" placeholder="enter message..." name="message" />
